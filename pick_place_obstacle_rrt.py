...
from src.obstacle_navigation_rrt import apply_obstacle_overrides
from src.pick_place_obstacle_rrt import DEFAULT_PICK_PLACE_OBSTACLES, run_demo_with_obstacles
...
if __name__ == "__main__":
    ...
    obstacle_configs = apply_obstacle_overrides(
        base_obstacles=DEFAULT_PICK_PLACE_OBSTACLES,
